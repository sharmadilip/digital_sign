@extends('layouts.app', ['class' => 'login-page','pageSlug'=>'login', 'page' => __('Login Page'), 'contentClass' => 'login-page'])
    ...
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <p class="text-dark mb-2">Sign in with your login id and password</p>
